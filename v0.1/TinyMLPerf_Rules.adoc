...
The Open division allows using an arbitrary dataset set, training script, or model.
...
Pre- and post-processing must be the same as the reference implementation.
