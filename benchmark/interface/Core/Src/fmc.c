...
static void HAL_FMC_MspDeInit(void){
  ...
  */
  ...
  HAL_GPIO_DeInit(GPIOD, LCD_NWE_Pin|LCD_TE_Pin|LCD_D3_Pin|LCD_NOE_Pin
                          |LCD_D2_Pin|LCD_D1_Pin|LCD_D15_Pin|LCD_D0_Pin
                          |LCD_D14_Pin|LCD_D13_Pin);

  HAL_GPIO_DeInit(LCD_A0_RS_GPIO_Port, LCD_A0_RS_Pin);

  HAL_GPIO_DeInit(GPIOC, GPIO_PIN_7);

  HAL_GPIO_DeInit(GPIOE, LCD_D6_Pin|LCD_D11_Pin|LCD_D12_Pin|LCD_D5_Pin
                          |LCD_D8_Pin|LCD_D10_Pin|GPIO_PIN_7|LCD_D7_Pin
                          |LCD_D9_Pin);
